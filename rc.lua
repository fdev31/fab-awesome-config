...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "h",     function () awful.tag.incnmaster( 1, nil, true) naughty.notify({text='masters: '.. awful.screen.focused().selected_tag.master_count}) end,
              {description = "increase the number of master clients", group = "layout"}),
    awful.key({ modkey, "Shift"   }, "l",     function () awful.tag.incnmaster(-1, nil, true) naughty.notify({text='masters: '.. awful.screen.focused().selected_tag.master_count}) end,
              {description = "decrease the number of master clients", group = "layout"}),
    awful.key({ modkey, "Control" }, "h",     function () awful.tag.incncol( 1, nil, true)   naughty.notify({text='cols: '.. awful.screen.focused().selected_tag.column_count}) end,
              {description = "increase the number of columns", group = "layout"}),
    awful.key({ modkey, "Control" }, "l",     function () awful.tag.incncol(-1, nil, true)   naughty.notify({text='cols: '.. awful.screen.focused().selected_tag.column_count}) end,
...
globalkeys = gears.table.join(globalkeys, table.unpack(ck.keys))
...
if menu_mod.keys then
    globalkeys = gears.table.join(globalkeys, table.unpack(menu_mod.keys))
end
if menu_mod.client_keys then
    clientbuttons = gears.table.join(clientbuttons, table.unpack(menu_mod.client_keys))
end
-- Set keys
